...
import { Breadcrumb, BreadcrombItem, Button, Form, FormGroup, Label, Input, Col} from 'reactstrap';
                ...
                <div className="col-12 col-md-9">
                    <Form onSubmit={this.handleSubmit}>
                        ...
                        <FormGroup row>
                            ...
                            <Col md={10}>
                                <Input type="tel" id="telnum" name="telnum" placeholder="Telephone #" value={this.state.telnum} onChange={this.handleInputChange}/>
                            </Col>
                        </FormGroup>
                        <FormGroup row>
                        ...
                        <FormGroup row>
                            ...
                            <Col md={10}>
                                 <Input type="textarea" id="message" name="message" rows="12" value={this.state.messsage} onChange={this.handleInputChange} />
                            </Col>
                        </FormGroup>
                        <FormGroup row>
